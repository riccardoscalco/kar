...
Package.on_use(function (api, where) {
  ...
  api.add_files('images/marker.svg', 'client');
  api.add_files('images/marker1.svg', 'client');
  api.add_files('images/marker2.svg', 'client');
  api.add_files('images/marker3.svg', 'client');
});